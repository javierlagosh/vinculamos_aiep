            ...
            <div class="main-wrapper main-wrapper-1">
                ...
                <aside id="sidebar-wrapper">
                        <div class="sidebar-brand">
                            <a href="javascript:void(0)"> <img alt="image" src="{{ asset('public/img/logoaiep.png') }}" class="header-logo" style="font-size: 15px;"/>
                                <span class="logo-name" style="font-size: 15px;">VINCULAMOS</span>
                            </a>
                        </div>
